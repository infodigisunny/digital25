...
We are not here to sell you something and then disappear. We are here to help your business get found by the people at the right time on the right platform.
          ...
          <section className='section-box box-prepared-section'>
            <div className='container'>
              ...
              <div className='row mt-45 justify-content-center text-center'>
  
  <div className='col-lg-4 d-flex justify-content-center'>
    <div className='card-feature-2 card-feature-list'>
      
      <div className='card-image d-flex justify-content-center'>
        <img src='/assets/imgs/page/homepage3/marketing.svg' alt='Adfinity Clarity' style={{ maxWidth: "80px" }} />
      </div>
  ...
  <div className='col-lg-4 d-flex justify-content-center'>
    <div className='card-feature-2 card-feature-list'>
      ...
      <div className='card-image d-flex justify-content-center'>
        <img src='/assets/imgs/page/homepage3/digital.svg' alt='Adfinity Clarity' style={{ maxWidth: "80px" }} />
      </div>
      ...
      <div className='card-info'>
        <Link href='#'>
          ...
          <p className='text-lg neutral-500'>
            We want to make high-quality search and digital marketing available to all businesses, not just big ones with big budgets. We want to help the business in Bangalore reach buyers in Brisbane, or the agency in Manchester compete with companies.
          </p>
        </Link>
      </div>
  ...
  <div className='col-lg-4 d-flex justify-content-center'>
    <div className='card-feature-2 card-feature-list'>
      ...
      <div className='card-image d-flex justify-content-center'>
        <img src='/assets/imgs/page/homepage3/product.svg' alt='Adfinity Clarity' style={{ maxWidth: "80px" }} />
      </div>
      ...
      <div className='card-info'>
        <Link href='#'>
          ...
          <p className='text-lg neutral-500'>
            We do not change the people who work on your account every month. The people you meet at the start are the ones who do the work.
          </p>
        </Link>
      </div>
