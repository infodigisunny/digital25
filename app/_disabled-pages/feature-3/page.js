                        ...
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-lg-6"><span className="btn btn-bg-brand-4 mb-25"><span>
                                    ...
                                    <h2 className="mt-15 mb-15">What You Get From<br className="d-none d-lg-block" />Adfinity Clarity Platform</h2>
                                ...
                                <div className="col-lg-6">
                                    <div className="box-banner-feature"> <img src="/assets/imgs/page/features/banner.png" alt="Adfinity Clarity" />
                            ...
                            <div className="box-border-rounded">
                                <div className="row align-items-center">
                                    <div className="col-lg-6 mb-40 text-center text-lg-start">
                                        <div className="image-feature-2"><img src="/assets/imgs/page/features/img-track.png" alt="Adfinity Clarity" /></div>
                                    </div>
                            ...
                            <div className="box-border-rounded">
                                <div className="row align-items-center">
                                    ...
                                    <div className="col-lg-6 mb-40 text-center text-lg-end">
                                        <div className="image-feature-2"><img src="/assets/imgs/page/features/img-track2.png" alt="Adfinity Clarity" /></div>
                                    </div>
                                </div>
                            </div>
                            <div className="row">
