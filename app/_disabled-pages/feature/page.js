                    ...
                    <section className="section-box box-content-feature">
                        <div className="container">
                            <div className="text-center"> <span className="btn btn-bg-brand-4 mb-25"><span>
                                ...
                                <h2 className="mt-15 mb-15">What You Get From Adfinity Clarity Platform</h2>
                                <p className="text-lg neutral-500 mb-25">Let's browse through all the great features you'll get when<br className="d-none d-lg-block" />you're in the Adfinity Clarity ecosystem</p>
                            </div>
                            <div className="row">
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature.png" alt="Adfinity Clarity" /></div>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature2.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature3.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature4.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature5.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature6.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature7.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature8.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-question card-question-2">
                                        <div className="card-image"> <img src="/assets/imgs/page/features/feature9.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info">
                        ...
                        <div className="container">
                            <div className="row align-items-end">
                                ...
                                <div className="col-lg-8 mb-30">
                                    <div className="row align-items-end">
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award.png" alt="Adfinity Clarity" /></div>
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award2.png" alt="Adfinity Clarity" /></div>
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award3.png" alt="Adfinity Clarity" /></div>
                                        <div className="col-sm-3 col-6 mb-30"><img src="/assets/imgs/page/about/award4.png" alt="Adfinity Clarity" /></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <Swiper {...swiperOptions} className="swiper-wrapper pb-70 pt-5">
                                        <SwiperSlide>
                                            <div className="card-testimonial-2">
                                                <div className="card-image"><img src="/assets/imgs/page/homepage5/review1.png" alt="Adfinity Clarity" /></div>
                                                <div className="card-info">
                                                    <div className="card-logo"><img src="/assets/imgs/page/homepage5/minty.png" alt="Adfinity Clarity" /></div>
                                                    ...
                                                    <div className="card-author">
                                                        ...
                                                        <div className="card-rates"><img src="/assets/imgs/page/homepage5/star-sm.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/page/homepage5/star-sm.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/page/homepage5/star-sm.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/page/homepage5/star-sm.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/page/homepage5/star-sm.svg" alt="Adfinity Clarity" /></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="card-testimonial-2">
                                                <div className="card-image"><img src="/assets/imgs/page/homepage5/review2.png" alt="Adfinity Clarity" /></div>
                                                <div className="card-info">
                                                    <div className="card-logo"><img src="/assets/imgs/page/homepage5/minty.png" alt="Adfinity Clarity" /></div>
                                                    <div className="card-comment">
                                                        <p className="text-md neutral-700">“Discover what sets this apart as the market's easiest and most powerful video interviewing platform, and why hiring managers consistently choose us over the competition Discover what sets this apart as the market's easiest and most powerful video interviewing platform, and why hiring managers consistently choose us over the competitionDiscover what sets this apart as the market's easiest and most powerful video interviewing platform, and why hiring managers consistently choose us over the competition”</p>
