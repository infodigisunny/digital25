                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6">
                                <div className="card-question">
                                    <div className="card-image"> <img src="/assets/imgs/page/help/bill.png" alt="Adfinity Clarity" /></div>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="card-question bg-1">
                                    <div className="card-image"> <img src="/assets/imgs/page/help/trouble.png" alt="Adfinity Clarity" /></div>
                                    <div className="card-info">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="card-question bg-2">
                                    <div className="card-image"> <img src="/assets/imgs/page/help/integration.png" alt="Adfinity Clarity" /></div>
                                    <div className="card-info">
                                        <h5>Integrations</h5>
                                        <div className="meta-post"> <span className="text-sm topic">32 topics </span><span className="text-sm article">168 articles </span></div>
                                        <p className="text-md neutral-600">Suspendisse vestibulum vitae enim a porta. Etiam pulvinar risus vitae turpis sagittis, sit amet placerat ipsum euismod. Morbi semper velit risus, ut convallis tortor bibendum vel. Morbi enim ex, elementum nec elit vel, gravida commodo augue.</p>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="card-question bg-3">
                                    <div className="card-image"> <img src="/assets/imgs/page/help/started.png" alt="Adfinity Clarity" /></div>
                                    <div className="card-info">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="card-question bg-4">
                                    <div className="card-image"> <img src="/assets/imgs/page/help/account.png" alt="Adfinity Clarity" /></div>
                                    <div className="card-info">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="card-question bg-5">
                                    <div className="card-image"> <img src="/assets/imgs/page/help/advance.png" alt="Adfinity Clarity" /></div>
                                    <div className="card-info">
