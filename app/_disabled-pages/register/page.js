...
'use client' // ✅ Required if using hooks or `process.env` in client components
...
if (process.env.NODE_ENV === 'production') {
    return null; // ✅ Don't show this page on live/production
  }
    return (
        <>
                                            ...
                                            <div className="box-form-register">
                                                ...
                                                <form className="form-register" action="#">
                                                    ...
                                                    <div className="other-login">
                                                        ...
                                                        <div className="box-button-register"><Link className="btn btn-login" href="#"><img src="/assets/imgs/page/register/google.svg" alt="Adfinity Clarity" /><span>Register with Google</span></Link><Link className="btn btn-login" href="#"><img src="/assets/imgs/page/register/twitter.svg" alt="Adfinity Clarity" /></Link><Link className="btn btn-login" href="#"><img src="/assets/imgs/page/register/linkedin.svg" alt="Adfinity Clarity" /></Link><Link className="btn btn-login" href="#"><img src="/assets/imgs/page/register/github.svg" alt="Adfinity Clarity" /></Link></div>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
