                ...
                <section className="section-box box-content-blog-2 box-content-blog-post">
                    <div className="container">
                        <div className="text-center blog-head"><span className="btn btn-brand-4-sm">Technology</span>
                            <h2 className="heading-2 mb-20 mt-15">Perfect product images with Generative AI in Adfinity Clarity platform</h2>
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-10">
                                <div className="box-content-detail-blog">
                                    <div className="box-image-header"> <img alt="Adfinity Clarity" src="/assets/imgs/page/blog/img-detail.png" /></div>
                                    <div className="box-detail-info">
                                        ...
                                        <p>The toppings you may chose for that TV dinner pizza slice when you forgot to shop for foods, the paint you may slap on your face to impress the new boss is your business. But what about your daily bread? </p><img src="/assets/imgs/page/blog/img-detail2.png" alt="Adfinity Clarity" />
                        ...
                        <div className="row">
                            <div className="col-lg-4">
                                <div className="card-news-style-2">
                                    <div className="card-image"> <Link href="/blog-post"><img src="/assets/imgs/page/blog/detail.png" alt="Adfinity Clarity" /></Link></div>
                            ...
                            <div className="col-lg-4">
                                <div className="card-news-style-2">
                                    <div className="card-image"> <Link href="/blog-post"><img src="/assets/imgs/page/blog/detail2.png" alt="Adfinity Clarity" /></Link></div>
                                    <div className="card-info">
                                        <div className="card-meta"> <Link className="btn btn-tag-sm" href="/blog-post">Technology</Link><span className="date-post">16 October 2023</span></div>
                            ...
                            <div className="col-lg-4">
                                <div className="card-news-style-2">
                                    <div className="card-image"> <Link href="/blog-post"><img src="/assets/imgs/page/blog/detail3.png" alt="Adfinity Clarity" /></Link></div>
                                    <div className="card-info">
                                        <div className="card-meta"> <Link className="btn btn-tag-sm" href="/blog-post">Technology</Link><span className="date-post">16 October 2023</span></div>
                                        <div className="card-title"> <Link className="link-new" href="/blog-post">Perfect product images with Generative AI in Adfinity Clarity platform</Link></div>
                                        <div className="card-more">   <Link className="btn btn-learmore-2" href="/blog-post">Read More
                                            <svg width={13} height={13} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <g clipPath="url(#clip0_599_4830)">
                                                    <path d="M10.6537 3.8149L1.71801 12.7506L0.25 11.2826L9.18469 2.3469H1.31V0.270508H12.7301V11.6906H10.6537V3.8149Z" fill="true" />
