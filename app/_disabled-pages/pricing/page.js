                                            ...
                                            <div className="card-faq card-faq-black">
                                                <div className="item-title">
                                                    <h6>
                                                        ...
                                                        </svg>Does Adfinity Clarity share my information with others?
                                                    </h6>
                                                </div>
                                                <div className="item-info">
                                    ...
                                    <Swiper {...swiperOptions} className="swiper-wrapper">
                                        <SwiperSlide>
                                            <div className="card-testimonial">
                                                <div className="card-rates"><img src="/assets/imgs/template/icons/star.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/template/icons/star.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/template/icons/star.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/template/icons/star.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/template/icons/star.svg" alt="Adfinity Clarity" /></div>
                                                ...
                                                <div className="card-author">
                                                    ...
                                                    <div className="author-image"><img src="/assets/imgs/page/homepage6/author.png" alt="Adfinity Clarity" /></div>
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="card-testimonial">
                                                ...
                                                <div className="card-author">
                                                    <div className="author-info"><span className="text-md author-name mr-10">ROBERT FOX</span><span className="text-lg neutral-500">@Amazon</span></div>
                                                    <div className="author-image"><img src="/assets/imgs/page/homepage6/author2.png" alt="Adfinity Clarity" /></div>
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="card-testimonial">
                                                ...
                                                <div className="card-author">
                                                    <div className="author-info"><span className="text-md author-name mr-10">ROBERT FOX</span><span className="text-lg neutral-500">@Amazon</span></div>
                                                    <div className="author-image"><img src="/assets/imgs/page/homepage6/author3.png" alt="Adfinity Clarity" /></div>
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="card-testimonial">
                                                ...
                                                <div className="card-author">
                                                    <div className="author-info"><span className="text-md author-name mr-10">ROBERT FOX</span><span className="text-lg neutral-500">@Amazon</span></div>
                                                    <div className="author-image"><img src="/assets/imgs/page/homepage6/author4.png" alt="Adfinity Clarity" /></div>
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                    ...
                    <section className="section-box wow animate__animated animate__fadeIn box-more-question box-more-question-2">
                        <div className="container">
                            <div className="block-more-question">
                                ...
                                <div className="question-right"><img src="/assets/imgs/page/homepage4/bg-question.png" alt="Adfinity Clarity" /></div>
                            </div>
                        </div>
                    </section>
                </div>
