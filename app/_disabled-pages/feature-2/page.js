                        ...
                        <div className="container">
                            ...
                            <div className="list-features-2">
                                <div className="item-list-feature">
                                    <div className="feature-left"> <Link href="#"><img src="/assets/imgs/page/features/img-feature.png" alt="Adfinity Clarity" /></Link></div>
                                ...
                                <div className="item-list-feature">
                                    <div className="feature-left"> <Link href="#"><img src="/assets/imgs/page/features/img-feature2.png" alt="Adfinity Clarity" /></Link></div>
                                    <div className="feature-right">
                                ...
                                <div className="item-list-feature">
                                    <div className="feature-left"> <Link href="#"><img src="/assets/imgs/page/features/img-feature3.png" alt="Adfinity Clarity" /></Link></div>
                                    <div className="feature-right">
