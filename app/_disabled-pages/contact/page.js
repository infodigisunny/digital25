                                            ...
                                            <div className="col-lg-12">
                                                <div className="card-feature-2">
                                                    ...
                                                    <div className="card-info">
                                                        ...
                                                        <div className="text-md neutral-700">
                                                            <div className="row">
                                                                <div className="col-sm-6"><Link className="neutral-700" href="/mailto:sale@Adfinity Clarity.com">sale@Adfinity Clarity.com</Link></div>
                                                                <div className="col-sm-6"><Link className="neutral-700" href="/mailto:contact@Adfinity Clarity.com">contact@Adfinity Clarity.com</Link></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
