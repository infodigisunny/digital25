    ...
    return (
        <>
            ...
            <Layout headerStyle={1} footerStyle={1} headerCls="header-style-2 header-style-4" >
                <div className="section-box box-banner-job"><img className="w-100" src="/assets/imgs/page/job/banner.png" alt="Adfinity Clarity" /></div>
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-3 order-lg-first">
                                    <div className="sidebar">
                                        ...
                                        <div className="box-sidebar-normal"><Link href="#"><img src="/assets/imgs/page/job/ads.png" alt="Adfinity Clarity" /></Link></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="box-image-get-touch"> <span className="setup"><img src="/assets/imgs/page/about/setup.png" alt="Adfinity Clarity" /></span><span className="icon-1"><img src="/assets/imgs/page/about/icon.png" alt="Adfinity Clarity" /></span><img src="/assets/imgs/page/about/img-touch.png" alt="Adfinity Clarity" /></div>
                                </div>
