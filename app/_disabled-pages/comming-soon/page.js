                        ...
                        <div className="row">
                            <div className="col-lg-7">
                                <div className="box-comming-soon-banner"><span className="btn btn-brand-4-sm">Coming Soon</span>
                                    ...
                                    <div className="box-socials-commingsoon"><Link className="icon-socials icon-facebook" href="#"><img alt="Adfinity Clarity" src="/assets/imgs/template/icons/fb.svg" /></Link><Link className="icon-socials icon-instagram" href="#"><img alt="Adfinity Clarity" src="/assets/imgs/template/icons/in.svg" /></Link><Link className="icon-socials icon-twitter" href="#"><img alt="Adfinity Clarity" src="/assets/imgs/template/icons/tw.svg" /></Link><Link className="icon-socials icon-be" href="#"><img alt="Adfinity Clarity" src="/assets/imgs/template/icons/be.svg" /></Link></div>
                                </div>
                            </div>
