            ...
            <Layout headerStyle={1} footerStyle={1} headerCls="header-style-2 header-style-4" >
                <div>
                        ...
                        <div className="banner-hero hero-6">
                            <div className="container">
                                <div className="banner-inner">
                                    <div className="box-banner-left"><Link className="btn btn-brand-4-sm" href="#">Careers</Link>
                                        <h1 className="display-2 mb-30 mt-25">Exciting Career <br className="d-none d-lg-block" />Opportunities Await</h1>
                                        <p className="text-lg neutral-500 mb-55">Find to open shifts based on the location, types of work, and our business rating Work for the most.</p>
                                    ...
                                    <div className="box-banner-right">
                                        <div className="box-images-banner-6"><img src="/assets/imgs/page/careers/banner.png" alt="Adfinity Clarity" /></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-lg-6 mb-40">
                                    <div className="image-feature-2"><img src="/assets/imgs/page/homepage3/img-feature.png" alt="Adfinity Clarity" /></div>
                                </div>
                                <div className="col-lg-6 mb-40">
                                    <div className="internet-icon"><span /> Benefit</div>
                                    <h2 className="heading-2 mb-20">What job profiles are we currently looking for?</h2>
                                    <p className="text-lg neutral-700">Insipidity the sufficient discretion imprudence resolution sir him decisively. Proceed how any engaged visitor. Explained propriety off out perpetual.</p>
                                    <div className="row mt-50">
                                        <div className="col-lg-6 col-sm-6">
                                            <div className="card-feature-2">
                                                ...
                                                <div className="card-info"><Link href="#">
                                                    <h3 className="text-22-bold">Career growth</h3></Link>
                                        ...
                                        <div className="col-lg-6 col-sm-6">
                                            <div className="card-feature-2">
                                                ...
                                                <div className="card-info"><Link href="#">
                                                    <h3 className="text-22-bold">Great culture</h3></Link>
                                                    <p className="text-md neutral-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, iste</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-6 col-sm-6">
                                            <div className="card-feature-2">
                                                ...
                                                <div className="card-info"><Link href="#">
                                                    <h3 className="text-22-bold">Flexible hours</h3></Link>
                                                    <p className="text-md neutral-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, iste</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="col-lg-6 col-sm-6">
                                            <div className="card-feature-2">
                                                ...
                                                <div className="card-info"><Link href="#">
                                                    <h3 className="text-22-bold">Competitive salary</h3></Link>
                                                    <p className="text-md neutral-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, iste</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="box-buttons-feature-4"><Link className="btn btn-black" href="#">Join Now
                    ...
                    <section className="section-box box-open-job">
                        <div className="container">
                            <div className="text-center"><span className="btn btn-brand-4-sm">Job openings</span>
                                <h2 className="heading-2 mb-20 mt-15">Open job position</h2>
                                <p className="text-lg">Adfinity Clarity is an independent web design studio with a rich history. Founded in 1999, it gathered the best web designers  developers.</p>
                                <div className="box-button-preparing"><Link className="btn btn-neutral-100" href="#">IT Management</Link><Link className="btn btn-neutral-100" href="#">Data Security</Link><Link className="btn btn-neutral-100" href="#">Business Reform</Link><Link className="btn btn-neutral-100" href="#">Firewall Advancement</Link><Link className="btn btn-neutral-100" href="#">Infrastructure Plan</Link></div>
                            </div>
                    ...
                    <section className="section-box wow animate__animated animate__fadeIn box-how-it-work">
                        <div className="container">
                            <div className="text-center"><Link className="btn btn-brand-4-sm" href="#">How It Works</Link>
                                <h2 className="mt-15 mb-20">How to apply to the Adfinity Clarity platform<br className="d-none d-lg-block" />and growing your career</h2>
                                <p className="text-lg neutral-500 mb-55">Bole nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo conididunt ut labore et dolore magna aliqua ut enim ad minim veniam</p>
                            </div>
                            <div className="row">
                                    ...
                                    <div className="box-border-rounded">
                                        <div className="card-casestudy">
                                            <div className="card-title">
                                                <h6> <span className="number">1</span>Find the Job sources</h6>
                                            </div>
                                ...
                                <div className="col-lg-4">
                                    <div className="box-border-rounded">
                                        <div className="card-casestudy">
                                            <div className="card-title">
                                                <h6> <span className="number">2</span>Submit your CV</h6>
                                            </div>
                                            <div className="card-desc">
                                                <p>Simple and cost effective to run high-performance queries on petabytes of semi-structured and structured data so that you can build powerful reports and dashboards.</p>
                                            </div>
                                ...
                                <div className="col-lg-4">
                                    <div className="box-border-rounded">
                                        <div className="card-casestudy">
                                            <div className="card-title">
                                                <h6> <span className="number">3</span>Interview</h6>
                                            </div>
                                            <div className="card-desc">
                                                <p>Simple and cost effective to run high-performance queries on petabytes of semi-structured and structured data so that you can build powerful reports and dashboards.</p>
                                            </div>
