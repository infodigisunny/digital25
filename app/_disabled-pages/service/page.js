                            ...
                            <div className="row mt-65">
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-we-know">
                                        <div className="card-image"> <img src="/assets/imgs/page/services/img.png" alt="Adfinity Clarity" /></div>
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-we-know">
                                        <div className="card-image"> <img src="/assets/imgs/page/services/img2.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info"> <Link className="card-title" href="#">
                                            <h4>Business Solution</h4>
                                            <svg width={38} height={38} viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width={38} height={38} rx={19} fill="true" />
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-we-know">
                                        <div className="card-image"> <img src="/assets/imgs/page/services/img3.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info"> <Link className="card-title" href="#">
                                            <h4>Business Solution</h4>
                                            <svg width={38} height={38} viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width={38} height={38} rx={19} fill="true" />
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-we-know">
                                        <div className="card-image"> <img src="/assets/imgs/page/services/img4.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info"> <Link className="card-title" href="#">
                                            <h4>Business Solution</h4>
                                            <svg width={38} height={38} viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width={38} height={38} rx={19} fill="true" />
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-we-know">
                                        <div className="card-image"> <img src="/assets/imgs/page/services/img5.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info"> <Link className="card-title" href="#">
                                            <h4>Business Solution</h4>
                                            <svg width={38} height={38} viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width={38} height={38} rx={19} fill="true" />
                                ...
                                <div className="col-lg-4 col-md-6">
                                    <div className="card-we-know">
                                        <div className="card-image"> <img src="/assets/imgs/page/services/img6.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-info"> <Link className="card-title" href="#">
                                            <h4>Business Solution</h4>
                                            <svg width={38} height={38} viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width={38} height={38} rx={19} fill="true" />
                    ...
                    <section className="section-box wow animate__animated animate__fadeIn box-why-choose-us">
                        <div className="container">
                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-6">
                                    <div className="box-image-why"> <img src="/assets/imgs/page/services/img-chart.png" alt="Adfinity Clarity" /><img src="/assets/imgs/page/services/img-chart2.png" alt="Adfinity Clarity" /></div>
                    ...
                    <section className="section-box wow animate__animated animate__fadeIn box-preparing-3">
                        <div className="container">
                            <div className="text-center">
                                ...
                                <p className="text-lg neutral-700">Adfinity Clarity is an independent web design studio with a rich history. Founded in 1999, it<br className="d-none d-lg-block" />gathered the best web designers  developers.</p>
                            </div>
                            ...
                            <div className="row align-items-center">
                                ...
                                <div className="col-lg-6 mb-40">
                                    <div className="box-padding-left-50">
                                        ...
                                        <p className="text-lg neutral-700">Adfinity Clarity is an independent web design studio with a rich history. Founded in 1999, it gathered the best web designers  developers.</p>
