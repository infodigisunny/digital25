            ...
            <div className="row mt-115">
                <div className="col-lg-4">
                    <div className="card-testimonial">
                        ...
                        <div className="card-author">
                            ...
                            <div className="author-image"><img src="/assets/imgs/page/homepage6/author.png" alt="Adfinity Clarity" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4">
                    <div className="card-testimonial">
                        ...
                        <div className="card-author">
                            <div className="author-info"><span className="text-md author-name mr-10">ROBERT FOX</span><span className="text-lg neutral-500">@Amazon</span></div>
                            <div className="author-image"><img src="/assets/imgs/page/homepage6/author2.png" alt="Adfinity Clarity" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4">
                    <div className="card-testimonial">
                        ...
                        <div className="card-author">
                            <div className="author-info"><span className="text-md author-name mr-10">ROBERT FOX</span><span className="text-lg neutral-500">@Amazon</span></div>
                            <div className="author-image"><img src="/assets/imgs/page/homepage6/author3.png" alt="Adfinity Clarity" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4">
                    <div className="card-testimonial">
                        ...
                        <div className="card-author">
                            <div className="author-info"><span className="text-md author-name mr-10">ROBERT FOX</span><span className="text-lg neutral-500">@Amazon</span></div>
                            <div className="author-image"><img src="/assets/imgs/page/homepage6/author4.png" alt="Adfinity Clarity" />
                            </div>
                        </div>
                    </div>
                </div>
                <div className="col-lg-4">
                    <div className="card-testimonial">
                        ...
                        <div className="card-author">
                            <div className="author-info"><span className="text-md author-name mr-10">ROBERT FOX</span><span className="text-lg neutral-500">@Amazon</span></div>
                            <div className="author-image"><img src="/assets/imgs/page/homepage6/author5.png" alt="Adfinity Clarity" />
                            </div>
                        </div>
                    </div>
                </div>
