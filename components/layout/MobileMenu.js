                    ...
                    <div className="mobile-header-content-area">
                        <div className="perfect-scroll">
                            ...
                            <div className="mobile-social-icon mb-50">
                                <h6 className="mb-25">Follow Us</h6><Link className="icon-socials icon-facebook" href="https://www.facebook.com/adfinityclarity/"><img alt="Facebook icon" src="/assets/imgs/template/icons/fb.svg" /></Link><Link className="icon-socials icon-linkedin" href="https://www.linkedin.com/in/adinity-clarity/"><img alt="Linkedin" src="/assets/imgs/template/icons/linkedin.svg" /></Link><Link className="icon-socials icon-youtube" href="https://www.youtube.com/@AdfinityClarity"><img alt="Youtube" src="/assets/imgs/template/icons/youtube.svg" /></Link><Link className="icon-socials icon-instagram" href="https://www.instagram.com/adfinityclarity/"><img alt="Instagram" src="/assets/imgs/template/icons/instagram.svg" /></Link><Link className="icon-socials icon-instagram" href="https://x.com/adfinityclarity"><img alt="x" src="/assets/imgs/template/icons/x.svg" /></Link>
                            </div>
