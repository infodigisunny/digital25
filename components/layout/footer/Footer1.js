        ...
        <>
            <footer className="footer footer-style-3">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 col-md-3 col-sm-12"><Link className='d-flex' href='/' aria-label='Adfinity Clarity Logo'><img alt="Adfinity Clarity Logo" src="/full-logo.webp" class="img1" /></Link>
