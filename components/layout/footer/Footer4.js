    ...
    return (
        <>
            <footer className="footer footer-style-3 footer-style-4">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-3 col-md-3 col-sm-12"><Link href="/"><img alt="Adfinity Clarity" src="/assets/imgs/template/logo.svg" /></Link>
                        ...
                        <div className="col-lg-3 col-md-4 col-xs-6 text-start text-md-end">
                            <div className="text-start d-inline-block mt-30">
                                ...
                                </p><div className="box-socials-footer" /><a className="icon-socials icon-facebook" href="#"><img alt="Adfinity Clarity" src="/assets/imgs/template/icons/fb.svg" /></a><a className="icon-socials icon-instagram" href="#"><img alt="Adfinity Clarity" src="/assets/imgs/template/icons/in.svg" /></a><a className="icon-socials icon-twitter" href="#"><img alt="Adfinity Clarity" src="/assets/imgs/template/icons/tw.svg" /></a><a className="icon-socials icon-be" href="#"><img alt="Adfinity Clarity" src="/assets/imgs/template/icons/be.svg" /></a>
                                <p />
                            </div>
                        </div>
                    </div>
                    <div className="footer-bottom mt-0">
                        <div className="row">
                            <div className="col-md-6 text-md-start text-center">
                                <p className="text-sm neutral-600">Copyright © 2023 Adfinity Clarity. All rights reserved.</p>
                            </div>
