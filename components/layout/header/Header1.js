                        ...
                        <div className="container">
                            <div className="top-bar-inner">
                                ...
                                <div className="box-top-bar-right"><a className="phone-icon text-md" href="tel:(262) 555-0131">(262)
                                    555-0131</a><a className="email-icon text-md" href="mailto:contact@Adfinity Clarity.com">contact@Adfinity Clarity.com</a></div>
                            </div>
                        </div>
                    </div>
                } */}
                  ...
                  <ul className='main-menu'>
                    <li className='has-children'>
                      ...
                      {/* <ul className='sub-menu'>
                        ...
                        <li>
                          <Link href='/seo-search-engine-optimization'>Web Agency</Link>
                        </li>
                        <li>
                    ...
                    <Link className='active' href='/about-us' aria-label='About Us'>
                        About Us
                      </Link>
                            ...
                            <div className='col-lg-4'>
                              <div className='box-desc-menu'>
                                <h6 className='text-16-semibold'>
                                  Adfinity Clarity - Modern Multipurpose Template
                                </h6>
