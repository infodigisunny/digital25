        ...
        <>
            ...
            <section className="section-box wow animate__animated animate__fadeIn box-testimonials-3">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 mb-30"><img src="/assets/imgs/page/homepage1/img-testimonial.png" alt="Adfinity Clarity" />
                        </div>
                                    ...
                                    <Swiper {...swiperOptions}>
                                        <SwiperSlide>
                                            <div className="card-testimonial-3">
                                                <div className="card-image"><img src="/assets/imgs/page/homepage1/img-review.png" alt="Adfinity Clarity" /></div>
                                                <div className="card-info">
                                                    <p className="text-md neutral-500">“As a long-time user of Adfinity Clarity Platform's
                                                    ...
                                                    <div className="card-author-review">
                                                        ...
                                                        <div className="card-rate"><img src="/assets/imgs/page/homepage1/star.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/page/homepage1/star.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/page/homepage1/star.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/page/homepage1/star.svg" alt="Adfinity Clarity" /><img src="/assets/imgs/page/homepage1/star.svg" alt="Adfinity Clarity" /></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="card-testimonial-3">
                                                <div className="card-image"><img src="/assets/imgs/page/homepage1/img-review-2.png" alt="Adfinity Clarity" /></div>
                                                <div className="card-info">
                                                    <p className="text-md neutral-500">“I recently started using Adfinity Clarity Platform,
