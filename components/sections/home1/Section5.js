          ...
          <div className='row align-items-center'>
            <div className='col-lg-6 mb-40'>
              ...
              <p className='text-lg neutral-700'>
                We help businesses grow by increasing sales and attracting more leads. Take a look at our
                  ...
                  <div className='card-feature-2'>
                    ...
                    <h3 className='text-22-bold'>Targeted Marketing</h3>
                      <p className='text-md neutral-700'>
                       We use SEO, paid ads, and content to reach the right audience. This helps your business
connect with people who are most likely to become customers.
                      </p>
                    </div>
                  </div>
                </div>
                <div className='col-lg-12'>
                  <div className='card-feature-2'>
                    ...
                    <div className='card-info'>
                     ...
                     <p className='text-md neutral-700'>
                        We create landing pages that work. Our email campaigns are clear and focused. We also use
social media to keep prospects interested and guide them to buy from you.
                      </p>
                    </div>
                  </div>
                </div>
                <div className='col-lg-12'>
                  <div className='card-feature-2'>
                    ...
                    <div className='card-info'>
                     ...
                     <p className='text-md neutral-700'>
                        We track campaign results and adjust quickly. This ensures your business keeps growing
with steady leads and increased sales.
                      </p>
                    </div>
                  </div>
                </div>
