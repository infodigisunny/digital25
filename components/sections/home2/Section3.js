                    ...
                    <div className="row">
                        <div className="col-lg-4 col-sm-6">
                            <div className="card-features-5">
                                <div className="card-image"><img src="/assets/imgs/page/homepage2/web.svg" alt="Adfinity Clarity" /></div>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="card-features-5">
                                <div className="card-image"><img src="/assets/imgs/page/homepage2/3d.svg" alt="Adfinity Clarity" /></div>
                                <div className="card-info">
                                    <h6>3D Animation</h6>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="card-features-5">
                                <div className="card-image"><img src="/assets/imgs/page/homepage2/social.svg" alt="Adfinity Clarity" /></div>
                                <div className="card-info">
                                    <h6>Social Media</h6>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="card-features-5">
                                <div className="card-image"><img src="/assets/imgs/page/homepage2/engine.svg" alt="Adfinity Clarity" /></div>
                                <div className="card-info">
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="card-features-5">
                                <div className="card-image"><img src="/assets/imgs/page/homepage2/security.svg" alt="Adfinity Clarity" />
                                </div>
                                <div className="card-info">
                                    <h6>Data Security</h6>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="card-features-5">
                                <div className="card-image"><img src="/assets/imgs/page/homepage2/firewall.svg" alt="Adfinity Clarity" />
                                </div>
                                <div className="card-info">
