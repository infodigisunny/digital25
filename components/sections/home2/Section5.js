                            ...
                            <div className="row">
                                <div className="col-lg-6 col-sm-6">
                                    <div className="card-features-5">
                                        <div className="card-image"><img src="/assets/imgs/page/homepage2/market.svg" alt="Adfinity Clarity" /></div>
                                    ...
                                    <div className="card-features-5">
                                        <div className="card-image"><img src="/assets/imgs/page/homepage2/content.svg" alt="Adfinity Clarity" /></div>
                                        <div className="card-info">
                                ...
                                <div className="col-lg-6 col-sm-6 pt-40">
                                    <div className="card-features-5">
                                        <div className="card-image"><img src="/assets/imgs/page/homepage2/social2.svg" alt="Adfinity Clarity" /></div>
                                        <div className="card-info">
                                    ...
                                    <div className="card-features-5">
                                        <div className="card-image"><img src="/assets/imgs/page/homepage2/daily.svg" alt="Adfinity Clarity" />
                                        </div>
                                        <div className="card-info">
                                            <h6>Daily Updates</h6>
