            ...
            <section className="section-box wow animate__animated animate__fadeIn box-case-study-2">
                <div className="container">
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-5"><img src="/assets/imgs/page/homepage2/img-case.png" alt="Adfinity Clarity" /></div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-7 text-center"><img src="/assets/imgs/page/homepage2/img-case2.png" alt="Adfinity Clarity" />
                        </div>
                    </div>
                </div>
            </section>
