                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-6 text-center">
                            <div className="box-image-client"><img src="/assets/imgs/page/homepage2/chart.png" alt="Adfinity Clarity" />
                                <div className="img-sold"><img src="/assets/imgs/page/homepage2/sold.png" alt="Adfinity Clarity" /></div>
                            </div>
                        </div>
