                    ...
                    <div className="row mt-40">
                        <div className="col-lg-5">
                            <div className="card-design">
                                <div className="card-image"><img alt="Adfinity Clarity" src="/assets/imgs/page/homepage6/ready.png" /></div>
                        ...
                        <div className="col-lg-7">
                            <div className="card-design card-design-style2">
                                <div className="card-image"><img alt="Adfinity Clarity" src="/assets/imgs/page/homepage6/integration.png" />
                                </div>
                                <div className="card-info">
                        ...
                        <div className="col-xl-4 col-lg-6">
                            <div className="card-design card-design-style3">
                                <div className="card-image"><img alt="Adfinity Clarity" src="/assets/imgs/page/homepage6/fast.png" /></div>
                                <div className="card-info">
                        ...
                        <div className="col-xl-4 col-lg-6">
                            <div className="card-design card-design-style4">
                                <div className="card-image"><img alt="Adfinity Clarity" src="/assets/imgs/page/homepage6/design.png" /></div>
                                <div className="card-info">
                        ...
                        <div className="col-xl-4 col-lg-6">
                            <div className="card-design card-design-style5">
                                <div className="card-image"><img alt="Adfinity Clarity" src="/assets/imgs/page/homepage6/power.png" /></div>
                                <div className="card-info">
