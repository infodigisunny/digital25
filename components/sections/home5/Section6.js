                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-3 text-end">
                            <div className="card-feature">
                                <div className="card-image"><img src="/assets/imgs/page/homepage6/safe.png" alt="Adfinity Clarity" /></div>
                            ...
                            <div className="card-feature">
                                <div className="card-image"><img src="/assets/imgs/page/homepage6/transaction.png" alt="Adfinity Clarity" />
                                </div>
                                <div className="card-info">
                        ...
                        <div className="col-lg-6 text-center">
                            <div className="box-main-img-feature"><img src="/assets/imgs/page/homepage6/img-feature.png" alt="Adfinity Clarity" />
                                <div className="img-sub-1 shape-1"><img src="/assets/imgs/page/homepage6/qrcode.png" alt="Adfinity Clarity" />
                                </div>
                                <div className="img-sub-2 shape-3"><img src="/assets/imgs/page/homepage6/storage.png" alt="Adfinity Clarity" /></div>
                            </div>
                        </div>
                        <div className="col-lg-3">
                            <div className="card-feature">
                                <div className="card-image"><img src="/assets/imgs/page/homepage6/great.png" alt="Adfinity Clarity" /></div>
                                <div className="card-info">
                            ...
                            <div className="card-feature">
                                <div className="card-image"><img src="/assets/imgs/page/homepage6/rapid.png" alt="Adfinity Clarity" /></div>
                                <div className="card-info">
