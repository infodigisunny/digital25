                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4">
                            <div className="card-news">
                                <div className="card-image"><Link href="/blog-post"><img src="/assets/imgs/page/homepage6/img-news2.png" alt="Adfinity Clarity" /></Link></div>
                        ...
                        <div className="col-lg-4">
                            <div className="card-news">
                                <div className="card-image"><Link href="/blog-post"><img src="/assets/imgs/page/homepage6/img-news3.png" alt="Adfinity Clarity" /></Link></div>
                                <div className="card-info"><Link className="heading-5" href="/blog-post">What to expect on your
                                    first technical interview?</Link></div>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            <div className="card-news">
                                <div className="card-image"><Link href="/blog-post"><img src="/assets/imgs/page/homepage6/img-news4.png" alt="Adfinity Clarity" /></Link></div>
                                <div className="card-info"><Link className="heading-5" href="/blog-post">What to expect on your
                                    first technical interview?</Link></div>
                            </div>
                        </div>
