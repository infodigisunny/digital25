                                ...
                                <div className="card-team-main">
                                    <div className="card-info"><Link className="btn btn-bg-linear-2 mb-20" href="#"><span>
                                        <svg width={24} height={24} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <h2 className="heading-2 mb-20">Own your job interview, with the power of AI</h2>
                                        </Link>
                                        <p className="text-xl mb-60">Tristique tellus feugiat sagittis mattis ut ipsum amet enim
                                            gravida lectus accumsan scelerisque lectus at anon nibh rutrum at eget sed.</p>
                                    </div>
                                    <div className="card-image"><Link href="#"><img src="/assets/imgs/page/homepage5/img-team.png" alt="Adfinity Clarity" /></Link></div>
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="row">
                                    <div className="col-lg-6">
                                        <div className="card-team">
                                            <div className="card-info"><Link href="#">
                                                <h2 className="heading-1 mb-10">350+</h2>
                                            </Link>
                                                <h4 className="heading-4 mb-10">Global downloads</h4>
                                                <p className="text-lg neutral-700">The app has garnered over 10,000 downloads
                                                    and counting</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-6">
                                        <div className="card-team">
                                            <div className="card-info"><Link href="#">
                                                <h2 className="heading-1 mb-10">400%</h2>
                                            </Link>
                                                <h4 className="heading-4 mb-10">Global customers</h4>
                                                <p className="text-lg neutral-700">We have assisted over 4,000 remarkable global
                                                    companies in their endeavors</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-12">
                                        <div className="card-team card-team-bg">
                                            <div className="card-info"><Link href="#">
                                                <h2 className="heading-1 mb-10">600%</h2>
                                            </Link>
                                                <h4 className="heading-4 mb-10">Return on investment</h4>
                                                <p className="text-xl neutral-700 mb-55">Discover what sets this apart as the
                                                    market's easiest and most powerful video interviewing platform, and
                                                    why hiring managers consistently choose us over the competition</p><Link className="btn btn-linear-rounded" href="#">Subscribe
