                                    ...
                                    <div className="block-banner">
                                        ...
                                        <div className="cards-banner">
                                            <div className="card-banner-1 linear-2">
                                                <div className="card-image"><img src="/assets/imgs/page/homepage5/manage.svg" alt="Adfinity Clarity" /></div>
                                            ...
                                            <div className="card-banner-2 linear-1">
                                                <div className="card-image"><img src="/assets/imgs/page/homepage5/dynamic.svg" alt="Adfinity Clarity" /></div>
                                                <div className="card-info"><Link className="text-24-semibold neutral-1000 text-uppercase" href="#">Dynamic features for a distinctive and refreshing customer
                                                    experience</Link></div>
                                            </div><Link className="btn btn-start-trial" href="#"><img src="/assets/imgs/page/homepage5/start.svg" alt="Adfinity Clarity" /> Start Your Free
                                                Trial today
