                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6">
                                <div className="card-pricing">
                                    <div className="card-image">
                                        <div className="card-icon"><img src="/assets/imgs/page/homepage5/basic.png" alt="Adfinity Clarity" />
                                        </div>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="card-pricing card-pricing-popular">
                                    ...
                                    <div className="card-image">
                                        <div className="card-icon"><img src="/assets/imgs/page/homepage5/professional.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-icon-info">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="card-pricing">
                                    <div className="card-image">
                                        <div className="card-icon"><img src="/assets/imgs/page/homepage5/enterprise.png" alt="Adfinity Clarity" /></div>
                                        <div className="card-icon-info">
