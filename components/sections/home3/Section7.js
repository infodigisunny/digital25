                ...
                <div className="container">
                        ...
                        <div className="row">
                            <div className="col-lg-6 mb-30"><Link className="btn btn-border-brand-4 text-linear-3" href="#">Lead
                                ...
                                <h3 className="heading-2 neutral-0 mt-20 mb-20">Maximize your marketing potential with our
                                    solutions</h3>
                                <p className="text-lg neutral-200 mb-35">Adfinity Clarity is an independent web design studio with a rich
                                ...
                                <div className="card-lead-list">
                                    <div className="item-lead">
                                        <div className="card-lead">
                                            <div className="card-image"><img src="/assets/imgs/page/homepage3/discover.svg" alt="Adfinity Clarity" /></div>
                    ...
                    <div className="col-lg-6 mb-30 text-center text-lg-end">
                        <div className="box-border-linear-3 linear-3">
                            <div className="box-border-linear-3-inner"><img src="/assets/imgs/page/homepage3/img-lead.png" alt="Adfinity Clarity" /></div>
                        </div>
                    </div>
                </div>
            </div>
