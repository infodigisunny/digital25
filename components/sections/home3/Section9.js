                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="card-pricing card-pricing-2">
                                                <div className="card-image justify-content-between">
                                                    ...
                                                    <div className="card-icon"><img src="/assets/imgs/page/homepage5/basic.png" alt="Adfinity Clarity" /></div>
                                                </div>
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="card-pricing card-pricing-2">
                                                <div className="card-image justify-content-between">
                                                    ...
                                                    <div className="card-icon"><img src="/assets/imgs/page/homepage5/professional.png" alt="Adfinity Clarity" />
                                                    </div>
                                                </div>
                                                <div className="card-lists">
                                                    <ul className="list-feature">
                                        ...
                                        <div className="col-lg-4 col-md-6">
                                            <div className="card-pricing card-pricing-2">
                                                <div className="card-image justify-content-between">
                                                    ...
                                                    <div className="card-icon"><img src="/assets/imgs/page/homepage5/enterprise.png" alt="Adfinity Clarity" />
                                                    </div>
                                                </div>
                                                <div className="card-lists">
                                                    <ul className="list-feature">
