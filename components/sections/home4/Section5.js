                        ...
                        <div className="swiper-container swiper-group-4">
                            <Swiper {...swiperOptions} className="swiper-wrapper">
                                <SwiperSlide>
                                    <div className="card-testimonial-4">
                                        <div className="card-author">
                                            <div className="box-author"><Link href="#"><img src="/assets/imgs/page/homepage4/author.png" alt="Adfinity Clarity" /></Link>
                                ...
                                <SwiperSlide>
                                    <div className="card-testimonial-4">
                                        <div className="card-author">
                                            <div className="box-author"><Link href="#"><img src="/assets/imgs/page/homepage4/author2.png" alt="Adfinity Clarity" /></Link>
                                ...
                                <SwiperSlide>
                                    <div className="card-testimonial-4">
                                        <div className="card-author">
                                            <div className="box-author"><Link href="#"><img src="/assets/imgs/page/homepage4/author3.png" alt="Adfinity Clarity" /></Link>
