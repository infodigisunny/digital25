                        ...
                        <div className="row">
                            <div className="col-lg-4 col-md-6">
                                <div className="card-pricing card-pricing-style-2 text-center">
                                    <div className="card-title"><img src="/assets/imgs/page/homepage4/pricing1.png" alt="Adfinity Clarity" />
                                    </div>
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="card-pricing card-pricing-style-2 text-center active">
                                    <div className="card-title"><img src="/assets/imgs/page/homepage4/pricing2.png" alt="Adfinity Clarity" />
                                    </div>
                                    <div className="card-prices mt-30">
                            ...
                            <div className="col-lg-4 col-md-6">
                                <div className="card-pricing card-pricing-style-2 text-center">
                                    <div className="card-title"><img src="/assets/imgs/page/homepage4/pricing3.png" alt="Adfinity Clarity" />
                                    </div>
                                    <div className="card-prices mt-30">
