        ...
        <div className="container">
          <div className="text-center">
            <h2 className="neutral-0 mb-20">
              Why Choose Adfinity Clarity for Digital Marketing?
            </h2>
            <p className="text-lg neutral-700">
              At Adfinity Clarity, we help businesses grow by focusing on what
              really works. Here’s why we are the right choice for you:
            </p>
          </div>
          <div className="row mt-90">
            <div className="col-lg-4 col-md-6">
              <div className="card-preparing-2">
                ...
                <div className="card-info">
                  ...
                  <p className="text-md neutral-700">
                    Data guides us in everything we do. This helps us make sure
                    every marketing decision we make is focused on getting the
                    best results
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card-preparing-2">
                ...
                <div className="card-info">
                  ...
                  <p className="text-md neutral-700">
                    Every business is different. That’s why we make sure our
                    marketing plans fit your business, goals, and needs instead
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card-preparing-2">
                ...
                <div className="card-info">
                  ...
                  <p className="text-md neutral-700">
                    {" "}
                    We’ve helped many businesses grow by increasing traffic,
                    generating more leads, and driving sales. Our clients trust
                    us because we deliver the best results that they desire.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-lg-4 col-md-6">
              <div className="card-preparing-2">
                ...
                <div className="card-info">
                  ...
                  <p className="text-md neutral-700">
                    {" "}
                    We know how important it is to make every dollar count. Our
                    job is to ensure you get the most value out of your
                    marketing budget.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card-preparing-2">
                ...
                <div className="card-info">
                  ...
                  <p className="text-md neutral-700">
                    We don’t just launch campaigns and forget about them. We
                    keep track of what’s working and make changes to get even
                    better results.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-md-6">
              <div className="card-preparing-2">
                ...
                <div className="card-info">
                  ...
                  <p className="text-md neutral-700">
                    Your customers are spread out across different platforms. We
                    use SEO, paid ads, content marketing, and social media to
                    ensure we are reaching them wherever they are.
                  </p>
                </div>
              </div>
            </div>
